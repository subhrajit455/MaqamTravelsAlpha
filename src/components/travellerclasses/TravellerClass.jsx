  ...
  return (
    <>
      <div className="border-l border-gray-200">
        <div
          className="h-full border-gray-200 cursor-pointer hover:bg-gray-50 transition px-2 py-2"
        ...
        <div class="relative w-full sm:w-72 z-[999]">
          {/* <!-- Dropdown --> */}
          {selectedClass && (
            <div class="absolute right-0 top-full w-72  bg-white border border-gray-300 rounded-md  p-4 z-[999]">
              {/* <!-- Adult --> */}
