...
const HotelBookingDetails = () => {
  ...
  const hotelName =
    item?.name || item?.title || item?.hotelName || "Beira Mar Beach Resorts";
  const hotelLocation =
    item?.location || item?.city || item?.country || "Benaulim, Goa";
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 font-poppins">
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500">
                2 minutes walk to Benaulim Beach
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="flex gap-2 h-[400px]">
              {/* Main Image */}
              <div
                className="flex-2 relative rounded-xl overflow-hidden group cursor-pointer flex-[2]"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-600">
                        Get ₹ 309 off. Pay using HSBC Bank Credit Cards EMI to
                        avail...
                      </p>
        ...
        <div className="grid grid-cols-3 gap-4 bg-[#D1E5FF] p-4 rounded-xl mt-6">
          <div className="font-semibold border-r border-white h-full pr-4">
            Room Type
          </div>
          <div className="font-semibold border-r border-white h-full pr-4">
            Room Options
        ...
        <div className="grid grid-cols-3 grid-rows-2 gap-4 bg-white p-4 rounded-xl mt-2 shadow-sm">
          ...
          <div className="row-span-2 border-r border-gray-300 pr-4">
            ...
            <p
              ...
              className="flex justify-between items-center text-sm text-gray-500 mt-3 cursor-pointer hover:text-teal-600 transition"
            >
          ...
          <div className="flex items-center border-b border-gray-200">
            <div>
              ...
              <div className="flex flex-col justify-center items-center w-full">
                ...
                <button
                  onClick={() => handleNavigateToSelectedRoomInformation()}
                  className="bg-[#00BBA7] text-white font-semibold px-2 py-1 rounded text-xs hover:bg-[#00BBA7] transition mt-2 w-1/2 text-center cursor-pointer truncate w-full"
                >
                  SELECT ROOM
                </button>
          ...
          <div className="flex items-center">
            <div>
              ...
              <div className="flex flex-col justify-center items-center w-full">
                ...
                <p className="text-[#778CA3] text-sm">Per Neight</p>
                <button className="bg-[#00BBA7] text-white font-semibold px-2 py-1 rounded text-xs hover:bg-[#00BBA7] transition mt-2 w-1/2 text-center cursor-pointer truncate w-full">
                  SELECT ROOM
                </button>
                <p className="text-xs text-gray-500">Includes taxes & fees</p>
              </div>
