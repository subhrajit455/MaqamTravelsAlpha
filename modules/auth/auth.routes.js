 ...
 *     tags:
 *       - Authentication
 *     summary: Retrieve avatar selection options
 *     description: Returns a list of pre-configured avatar image URLs available for registration.
 *     security: []
 *     responses:
 *       200:
 *         description: Avatar options retrieved successfully.
 *         content:
 *           application/json:
 *             schema:
 *               allOf:
